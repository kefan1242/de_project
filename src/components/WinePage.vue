<template>
  <div class="page">
    <div class="image-gallery">
      <img src="wine1.png" alt="Wine Image 1" />
      <img src="wine2.png" alt="Wine Image 2" />
      <img src="wine3.png" alt="Wine Image 3" />
      <img src="wine4.png" alt="Wine Image 4" />
    </div>
    ...
    <a href="https://github.com/kefan1242/de_project/tree/main/dataset_wine" target="_blank" class="link">View More Information</a>
...
export default {
  ...
  data() {
    return {
      userInput: "",
      messages: [
        { text: "Welcome to the Wine Enthusiast page, how can I assist you?", sender: "bot" },
      ],
    };
  },
  methods: {
